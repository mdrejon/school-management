...
class TeacherPageSetting extends Model
{
    use HasTranslations;
    ...
    {
        static::saved(fn () => Cache::forget('teacher_page_settings.current'));
    }
    ...
    {
        $row = Cache::rememberForever('teacher_page_settings.current', function () {
            $settings = static::query()->first();

            if (! $settings) {
                $settings = static::create([
                    'section_tagline' => ['en' => 'Our Teachers'],
                    'section_title' => ['en' => 'Meet With Our Teachers'],
                    'section_highlight' => ['en' => 'Teachers'],
                    'breadcrumb_title' => ['en' => 'Teachers'],
                ]);
            }
