...
class BlogPageSetting extends Model
{
    ...
    {
        static::saved(fn () => Cache::forget('blog_page_settings.current'));
    }
    ...
    {
        $row = Cache::rememberForever('blog_page_settings.current', function () {
            $settings = static::query()->first();

            if (! $settings) {
                $settings = static::create([
                    'section_tagline' => ['en' => 'Our Blog'],
                    'section_title' => ['en' => 'Latest News & Blog'],
                    'section_highlight' => ['en' => 'Blog'],
                    'breadcrumb_title' => ['en' => 'Our Blog'],
                ]);
            }
