...
class FaqPageSetting extends Model
{
    ...
    {
        static::saved(fn () => Cache::forget('faq_page_settings.current'));
    }
    ...
    {
        $row = Cache::rememberForever('faq_page_settings.current', function () {
            $settings = static::query()->first();

            if (! $settings) {
                $settings = static::create([
                    'section_tagline' => ["en" => "Faq's"],
                    'section_title' => ['en' => 'General frequently asked questions'],
                    'section_highlight' => ['en' => 'frequently'],
                    'cta_button_text' => ['en' => 'Have Any Question ?'],
                    'breadcrumb_title' => ["en" => "Faq's"],
                ]);
            }
