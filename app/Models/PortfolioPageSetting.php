...
class PortfolioPageSetting extends Model
{
    ...
    {
        static::saved(fn () => Cache::forget('portfolio_page_settings.current'));
    }
    ...
    {
        $row = Cache::rememberForever('portfolio_page_settings.current', function () {
            $settings = static::query()->first();

            if (! $settings) {
                $settings = static::create([
                    'section_tagline' => ['en' => 'Portfolio'],
                    'section_title' => ['en' => 'Explore Our Portfolio'],
                    'section_highlight' => ['en' => 'Portfolio'],
                    'breadcrumb_title' => ['en' => 'Portfolio'],
                ]);
            }
