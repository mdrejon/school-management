...
class BehaviorController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/Academic/Behavior/Index', [
            'behaviors' => $behaviors,
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('Admin/Academic/Behavior/Create', [
            'classes' => $classes,
            'sections' => $sections,
            'students' => $students,
            'filters' => $request->only('class_id', 'section_id'),
            'teachers' => \App\Models\User::role('staff')->get(),
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.academic.behaviors.index')->with('success', 'Behavior recorded successfully.');
    }
    ...
    public function edit(Request $request, Behavior $behavior)
    {
        ...
        return Inertia::render('Admin/Academic/Behavior/Edit', [
            'behavior' => $behavior,
            'classes' => $classes,
            'sections' => $sections,
            'students' => $students,
    ...
    public function update(Request $request, Behavior $behavior)
    {
        ...
        return redirect()->route('admin.academic.behaviors.index')->with('success', 'Behavior updated successfully.');
    }
    ...
    public function destroy(Behavior $behavior)
    {
        ...
        return redirect()->route('admin.academic.behaviors.index')->with('success', 'Behavior deleted successfully.');
    }
}
