...
class ClassLessonController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Teacher/ClassLesson/Index', [
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('Teacher/ClassLesson/Create', [
            'classes' => $classes,
            'sections' => $sections,
            'subjects' => $subjects,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teacher.class-lessons.index')->with('success', 'Class lesson created successfully.');
    }
    ...
    public function destroy(ClassLesson $classLesson)
    {
        ...
        return redirect()->route('teacher.class-lessons.index')->with('success', 'Class lesson deleted successfully.');
    }
}
