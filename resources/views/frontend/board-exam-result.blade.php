...
@section('content')
    ...
    <div class="wexnix_site-breadcrumb" @if($settings->board_exam_result_page_breadcrumb_image_url) style="background: url('{{ $settings->board_exam_result_page_breadcrumb_image_url }}')" @else style="background: url('{{ asset('frontend/assets/img/breadcrumb/01.jpg') }}')" @endif>
        <div class="container">
            <h2 class="wexnix_breadcrumb-title">{{ $settings->board_exam_result_page_breadcrumb_title ?? 'Board Exam Result' }}</h2>
            <ul class="wexnix_breadcrumb-menu">
                <li><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
                <li class="active">{{ $settings->board_exam_result_page_breadcrumb_title ?? 'Board Exam Result' }}</li>
            </ul>
        </div>
    </div>
    <!-- breadcrumb end -->
    ...
    <div class="pt-80 pb-80">
        <div class="container">
            <div class="wexnix_site-heading text-center mb-4">
                <h2 class="wexnix_site-title">Board Exam <span>Result</span></h2>
            </div>
            <div class="wexnix_search-filter-box bg-light p-4">
                <form action="#">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-6 col-lg-4">
                            <label class="wexnix_filter-label">Board Exam <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <label class="wexnix_filter-label">Year <span class="text-danger">*</span></label>
                            <select class="form-select">
                                <option>Select One</option>
                                <option>2026</option>
                                <option>2025</option>
                        ...
                        <div class="col-md-6 col-lg-2">
                            <button type="reset" class="btn btn-danger text-white w-100"><i class="fas fa-rotate"></i> Reset</button>
                        </div>
                        <div class="col-md-6 col-lg-2">
                            <button type="submit" class="btn btn-success text-white w-100"><i class="fas fa-search"></i> Search</button>
                        </div>
                    </div>
                </form>
            </div>
