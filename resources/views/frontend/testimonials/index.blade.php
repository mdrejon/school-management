...
@section('title', ($pageSettings->seo_title ?: $pageSettings->breadcrumb_title ?: 'Testimonials') . ' - ' . config('app.name'))
    ...
    <main class="wexnix_main">
        ...
        <div class="wexnix_testimonial-area wexnix_bg py-120">
            <div class="container">
                ...
                @else
                    <p class="text-center">{{ __('No testimonials available right now — please check back soon.') }}</p>
                @endif
            </div>
        </div>
