                        ...
                        <div class="col-lg-7 align-self-center">
                            <div class="wexnix_contact-form">
                                ...
                                <form method="post" action="{{ route('contact.store') }}" id="contact-form">
                                    ...
                                    <div class="wexnix_form-group">
                                        <input type="text" class="form-control" name="subject" value="{{ old('subject') }}" placeholder="Your Subject" required>
                                        @error('subject')
                                            <p class="text-danger small mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <button type="submit" class="wexnix_theme-btn">Send Message <i class="fas fa-paper-plane"></i></button>
