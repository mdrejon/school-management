<aside class="wexnix_home-sidebar">
    ...
    @if (!empty($siteSettings->{{ __('sidebar_minister_show))') }}
        <div class="wexnix_sidebar-widget">
            <h4 class="wexnix_sidebar-widget-title"><i class="fas fa-user-tie"></i> {{ $siteSettings->{{ __('sidebar_minister_title ?: "Hon\'ble Minister" }}') }}</h4>
    ...
    @if (!empty($siteSettings->{{ __('sidebar_secretary_show))') }}
        <div class="wexnix_sidebar-widget">
            <h4 class="wexnix_sidebar-widget-title wexnix_sidebar-title-alt"><i class="fas fa-user-tie"></i> {{ $siteSettings->{{ __('sidebar_secretary_title ?: \'Secretary\' }}') }}</h4>
            <div class="wexnix_sidebar-person">
                <div class="wexnix_sidebar-person-img">
    ...
    @if (!empty($siteSettings->{{ __('sidebar_principal_show) && \App\Models\ModuleSetting::isEnabled(\'principal\'))') }}
        <div class="wexnix_sidebar-widget">
            <h4 class="wexnix_sidebar-widget-title"><i class="fas fa-user-tie"></i> {{ $siteSettings->{{ __('sidebar_principal_title ?: \'Our Principal\' }}') }}</h4>
            <div class="wexnix_sidebar-person">
                <div class="wexnix_sidebar-person-img">
    ...
    @if (!empty($siteSettings->{{ __('sidebar_vice_principal_show))') }}
        <div class="wexnix_sidebar-widget">
            <h4 class="wexnix_sidebar-widget-title wexnix_sidebar-title-alt"><i class="fas fa-user-tie"></i> {{ $siteSettings->{{ __('sidebar_vice_principal_title ?: \'Our Vice Principal\' }}') }}</h4>
            <div class="wexnix_sidebar-person">
                <div class="wexnix_sidebar-person-img">
