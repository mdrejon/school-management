...
const fetchSyllabuses = debounce(() => {
    router.get(route('teacher.syllabuses.index'), {
...
const deleteSyllabus = (id) => {
    confirm.require({
        ...
        accept: () => {
            router.delete(route('teacher.syllabuses.destroy', id), {
                preserveScroll: true,
            });
        },
    });
        ...
        <Card class="shadow-sm border border-slate-100 rounded-xl bg-white">
            <template #title>
                <div class="flex items-center justify-end pb-2">
                    <Link :href="route('teacher.syllabuses.create')">
                                ...
                                <tr v-for="syllabus in syllabuses.data" :key="syllabus.id" class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-1">
                                            <a :href="route('teacher.syllabuses.download', syllabus.id)" target="_blank">
