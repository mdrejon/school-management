...
const fetchClassLessons = debounce(() => {
    router.get(route('teacher.class-lessons.index'), {
...
const deleteClassLesson = (id) => {
    confirm.require({
        ...
        accept: () => {
            router.delete(route('teacher.class-lessons.destroy', id), {
                preserveScroll: true,
            });
        },
    });
...
<template>
    <TeacherLayout title="Classlesson">
        <ConfirmDialog />
        ...
        <div class="mb-4 flex items-center justify-between">
            ...
            <Link :href="route('teacher.class-lessons.create')">
