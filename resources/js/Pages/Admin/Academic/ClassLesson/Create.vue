...
const fetchSections = () => {
    if (form.class_id) {
        router.get(route('admin.academic.class-lessons.create'), {
...
const submit = () => {
    ...
    })).post(route('admin.academic.class-lessons.store'), {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <AdminLayout title="Add New Class lessons">
        <div class="mb-4 flex items-center justify-between">
            ...
            <Link :href="route('admin.academic.class-lessons.index')">
