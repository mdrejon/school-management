...
const fetchSections = () => {
    if (form.class_id) {
        router.get(route('admin.academic.behaviors.edit', props.behavior.id), {
...
const submit = () => {
    ...
    router.post(route('admin.academic.behaviors.update', props.behavior.id), payload, {
        preserveScroll: true,
        onSuccess: () => {
...
<template>
    <AdminLayout title="Behavior Edit">
