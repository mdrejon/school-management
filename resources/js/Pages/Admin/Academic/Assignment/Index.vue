...
const fetchAssignments = debounce(() => {
    router.get(route('admin.academic.assignments.index'), {
...
const deleteAssignment = (id) => {
    confirm.require({
        ...
        accept: () => {
            router.delete(route('admin.academic.assignments.destroy', id), {
                preserveScroll: true,
            });
        },
    });
...
<template>
    <AdminLayout title="Assignments">
        ...
        <div class="mb-4">
            ...
            <p class="text-sm text-gray-500">Home - Admin - Assignments</p>
        </div>
            ...
            <template #content>
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-4">
                        <Link :href="route('admin.academic.assignments.create')">
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">Subject</th><th scope="col" class="px-6 py-3">Teacher</th>
                        ...
                        <tbody>
                            <template v-if="assignments.data.length > 0">
                                <tr v-for="assignment in assignments.data" :key="assignment.id" class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">{{ assignment.subject?.name || '-' }}</td><td class="px-6 py-4">{{ assignment.teacher?.name || '-' }}</td>
