...
const fetchPrayers = debounce(() => {
    router.get(route('admin.academic.prayers.index'), {
...
const deletePrayer = (id) => {
    confirm.require({
        ...
        accept: () => {
            router.delete(route('admin.academic.prayers.destroy', id), {
                preserveScroll: true,
            });
        },
    });
...
<template>
    <AdminLayout title="Prayer">
        ...
        <div class="mb-4 flex items-center justify-between">
            ...
            <Link :href="route('admin.academic.prayers.create')">
                            ...
                            <template v-if="prayers.data.length > 0">
                                <tr v-for="(prayer, index) in prayers.data" :key="prayer.id" class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-blue-500">
                                        <a v-if="prayer.file_path" :href="route('admin.academic.prayers.download', prayer.id)" target="_blank" class="hover:underline">Download File</a>
