...
<template>
    <AdminLayout title="Teachers List">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <Link :href="route('admin.staff.teachers.create')">
                    ...
                    <Column header="Action" style="width: 10%">
                        <template #body="{ data }">
                            <div class="flex gap-2">
                                <Link :href="route('admin.staff.teachers.edit', data.id)">
                                    <Button icon="pi pi-pencil" text rounded aria-label="Edit" />
                                </Link>
                                <Link :href="route('admin.staff.teachers.destroy', data.id)" method="delete" as="button">
