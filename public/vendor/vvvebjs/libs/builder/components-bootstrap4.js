...
Vvveb.Components.extend("_base", "html/form", {
    ...
    name: "Form",
    html: '<form><div class="mb-2"><label>Text</label><input type="text" class="form-control"></div></div></form>',
    properties: [{
        name: "Style",
        key: "style",
        htmlAttr: "class",
...
Vvveb.Components.extend("_base", "html/textinput", {
    ...
    html: '<div class="mb-2"><label>Text</label><input type="text" class="form-control"></div></div>',
    properties: [{
        name: "Value",
        key: "value",
        htmlAttr: "value",
...
Vvveb.Components.extend("_base", "html/selectinput", {
    ...
    html: '<div class="mb-2"><label>Choose an option </label><select class="form-control"><option value="value1">Text 1</option><option value="value2">Text 2</option><option value="value3">Text 3</option></select></div>',
