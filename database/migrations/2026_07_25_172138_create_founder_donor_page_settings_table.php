...
return new class extends Migration
{
    ...
    {
        Schema::create('founder_donor_page_settings', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('founders_table_title')->nullable();
            $table->json('donors_table_title')->nullable();
    ...
    {
        Schema::dropIfExists('founder_donor_page_settings');
    }
};
